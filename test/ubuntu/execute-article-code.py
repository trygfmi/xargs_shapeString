# python /Users/ojiro/Desktop/programming/running-terminal-commands-blog/xargs/xargs_shapeString/test/ubuntu/execute-article-code.py
...
procedure_cmd = f"""rm -rf test/ubuntu/xargs_shapeString
i=0
git_command_number=0
cd_command_number=1
target_directory="test/ubuntu/"
