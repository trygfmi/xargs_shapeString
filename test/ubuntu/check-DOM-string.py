# python /Users/ojiro/Desktop/programming/running-terminal-commands-blog/xargs/xargs_shapeString/test/ubuntu/check-DOM-string.py
...
quickstart_output_code = tree.xpath('(//div[@class="entry-content"]/details/pre[@class="wp-block-code has-background"]/code)[1]')
...
procedure_output_code = tree.xpath('(//details//details//code)[1]')
