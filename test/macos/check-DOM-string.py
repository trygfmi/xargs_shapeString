...
quickstart_output_code = tree.xpath('(//div[@class="entry-content"]/details/pre[@class="wp-block-code has-background"]/code)[2]')
...
procedure_output_code = tree.xpath('(//details//details//code)[2]')
