# python /Users/ojiro/Desktop/programming/running-terminal-commands-blog/xargs/xargs_shapeString/test/windows/wsl/execute-article-code.py
...
cd_command_number=1
target_directory="test/windows/wsl/"
...
procedure_cmd = f"""rm -rf test/windows/wsl/xargs_shapeString
i=0
git_command_number=0
cd_command_number=1
target_directory="test/windows/wsl/"
